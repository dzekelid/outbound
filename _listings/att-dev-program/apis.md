...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/outbound/master/_listings/att-dev-program/apis.md
...
- name: AT&T API - Post Messaging Outbound Senderaddress Requests
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/outbound/master/_listings/att-dev-program/3messagingoutboundsenderaddressrequests-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/outbound/master/_listings/att-dev-program/3messagingoutboundsenderaddressrequests-post-openapi.md
- name: AT&T API - Get Messaging Outbound Senderaddress Requestid Deliveryinfos
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/outbound/master/_listings/att-dev-program/3messagingoutboundsenderaddressrequestiddeliveryinfos-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/outbound/master/_listings/att-dev-program/3messagingoutboundsenderaddressrequestiddeliveryinfos-get-openapi.md
- name: AT&T API - Get SMS Outbound Requests Senderaddress Requestid Deliveryinfos
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/outbound/master/_listings/att-dev-program/3smsmessagingoutboundrequestssenderaddressrequestiddeliveryinfos-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/outbound/master/_listings/att-dev-program/3smsmessagingoutboundrequestssenderaddressrequestiddeliveryinfos-get-openapi.md
- name: AT&T API - Post SMS Outbound Senderaddress Requests
  x-api-slug: 3smsmessagingoutboundsenderaddressrequests-post
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/outbound/master/_listings/att-dev-program/3smsmessagingoutboundsenderaddressrequests-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/outbound/master/_listings/att-dev-program/3smsmessagingoutboundsenderaddressrequests-post-openapi.md
x-common:
- type: x-android-sdk
